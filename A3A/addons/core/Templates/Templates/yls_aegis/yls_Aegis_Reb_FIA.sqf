...
private _vehiclesCivCar = ["C_Quadbike_01_F", "C_Offroad_01_F", "C_Hatchback_01_sport_F", "C_SUV_01_F"];
["vehiclesCivTruck", ["C_Truck_02_transport_F", "C_Van_02_transport_F", "C_Van_02_vehicle_F", "C_Van_02_medevac_F", "C_Offroad_01_repair_F", "C_Van_01_fuel_F", "Aegis_I_E_Heli_Light_03_unarmed_ard_F"]] call _fnc_saveToTemplate;
...
if (_hasRF) then {
    _vehiclesCivCar pushBack "a3a_black_Pickup_rf";
    _vehiclesLightArmed pushBack "I_G_Pickup_hmg_rf","I_Pickup_rcws_rf";
};
...
#include "yls_Aegis_Reb_Vehicle_Attributes.sqf"
